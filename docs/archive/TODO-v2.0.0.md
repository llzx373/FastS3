...
> **【已归档 — 2026-08-26】** 本文件为 M9 v1.0.x → M14 v2.0.0 执行期的 TODO 清单,
> 全部里程碑已完成并门禁全勾选,已完成使命,冻结于此存档(内部相对链接指向归档前
> 位置,仅作历史参考)。
> 后续开发请使用根目录 [TODO.md](../../TODO.md)(当前 M17 私有化部署);
> M15~v2.2.1 执行期清单已归档:[TODO-v2.2.1.md](./TODO-v2.2.1.md);
> 规划依据 [NEXT-ROUND.md](../NEXT-ROUND.md) 与 [DESIGN-FUTURE.md](../DESIGN-FUTURE.md)、
> [S3-GAP.md](../S3-GAP.md)。
>
...
| [M12 Object Lock / WORM](#m12-v130-object-lock--worm) | v1.3.0 | ≈3 周 | 治理/合规保留 + 法定保留 + 可信时钟 | ✅ 完成(v1.3.0,2026-08-25) |
| [M13 容量与底座](#m13-v140-容量与底座) | v1.4.0 | ≈6 周 | 多设备扩容/再平衡 + 元数据分区过渡 + zstd | ✅ 完成(v1.4.0,2026-08-26) |
...
- [x] Z1-2 流水线顺序:明文 → zstd → (SSE 加密) → CRC(实施期补遗经用户裁决);读路径解压缓冲;元数据 CompressionInfo
