...
> **【已归档 — 2026-08-27】** 本文件为 M15 v2.1.0 → M16 v2.2.0 主力 + 审查修复 v2.2.1
> 执行期的 TODO 清单,全部里程碑已完成并门禁全勾选,冻结于此存档(内部相对链接指向
> 归档前位置,仅作历史参考)。
> 后续开发请使用根目录 [TODO.md](../../TODO.md)(M17 v2.3.0「可交付私有化」起)。
>
...
> [TODO-v2.0.0.md](./TODO-v2.0.0.md);
> v1.0.0(M0~M8)执行期清单见 [TODO-v1.0.0.md](./TODO-v1.0.0.md)。
