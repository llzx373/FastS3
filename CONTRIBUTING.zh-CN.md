...
设计与范围以 [docs/DESIGN.md](./docs/DESIGN.md) 为准。实现若与 DESIGN 冲突，先补 ADR，再改代码。用户可见行为还应对齐 [兼容矩阵](./docs/site/docs/reference/compat.zh.md)。
...
3. 一个 PR 只做一件事。用户可见行为变更须同步文档（`docs/site/` 英文 `*.md` 与中文 `*.zh.md`，或 `CHANGELOG.md` Unreleased）。文档站默认英文。
